...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('question_type', models.CharField(choices=[('long', 'long'), ('short', 'short'), ('MCQ', 'MCQ')], max_length=255)),
                ('level', models.CharField(choices=[('Easy', 'Easy'), ('Medium', 'Medium'), ('hard', 'hard')], max_length=255)),
                ('text', models.TextField()),
                ('marks', models.IntegerField()),
                ('is_required', models.BooleanField(default=False)),
                ('admin', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home.admin')),
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home.questionbank')),
                ('school', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home.school')),
